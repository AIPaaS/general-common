...
#-e 代表需要设置的环境变量
docker run -d --name general-common -p 10885:10885 -e "REST_REGISTRY_ADDR=10.19.13.13:29181" -e "REST_PORT=10885" -e "CONTEXT_PATH=general-common" -e "SDK_MODE=1" -e "CCS_NAME=aiopt-aiplatform" -e "ZK_ADDR=10.19.13.13:29181"  10.19.13.19:5000/general-common:v1.0 
#查看镜像启动日志
